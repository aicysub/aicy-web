...
<div class="preference-main" id="setup-2">
  ...
  <li><label for="white" id="white-label" onclick="first_white_click()"><img id="white-img" src="https://aic-group.sytes.net/images/themes/white-mode.webp" loading="lazy"></label><p><input type="radio" name="themes" id="white" value="white"><label for="white">ホワイト</label></p>   </li>  <li><label for="dark" onclick="first_dark_click()"><img id="dark-img" src="https://aic-group.sytes.net/images/themes/dark-mode.webp" loading="lazy"></label> <p>     <input type="radio" name="themes" id="dark" value="dark"><label for="dark">ダーク</label></p>  </li><li><label for="special" id="special-label" onclick="first_special_click()"><img id="special-img" src="https://aic-group.sytes.net/images/themes/special-mode.webp" loading="lazy"></label><p><input type="radio" name="themes" id="special" value="special"><label for="white">スペシャル</label></p></li></ul>
<br>
