...
setTimeout(function(){
loadCSS( "/owner/aicy/birthday.css<?php echo $css_v?>", document.getElementById("loadcss") );
},950);
setTimeout(function(){
    aicy_anime();
},1000);
    ...
    <div class="birthday">
      ...
      AIC_Groupの代表(?)で色々鯖運営してます<br>非営利団体ですのでお金は取っていません<br>寄付は受け付けてますのでお願いします(?)<br>また、あいしぃーのさーばー・MIC(自然災害、障害情報鯖)管理人です<br>入ってねー!!<br>不定期でみんなのサーバーに遊びに行きますので、皆さん、よろしくね!!<br>サーバー運営も受け付けてますので、詳しくは、DMまでー!<br>
      ちなみに、このページをアクセスすると一時的にスペシャルモードになりますよー！
</div>
</div>
