...
return FALSE;
    ...
    </video><br><p><a id="link-none" href="https://aic-group.sytes.net'.$g.'" download="'.$title.' - '.$k.'.webm">'.$video_title.'をダウンロードする ('.ByteToUnit($filesize).')</a><br>(ファイルは一時間以内に消去されます。)</p><br><a href="https://aic-group.sytes.net/tools/convert/webm-to-mp3?i='.$k.'&name='.$title.' - '.$k.'" class="download" type="submit">この動画をmp3に変換する</a>';
