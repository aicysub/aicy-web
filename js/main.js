...
$(document).ready(function() {
  ...
  loadCSS("https://cdn.jsdelivr.net/npm/bulma@0.9.3/css/bulma.min.css", document.getElementById("loadcss"));
});
setTimeout(function() {
  $(document).ready(function() {
    $('body').fadeIn(1000);
...
$(document).ready(function() {
  setTimeout(function() {
    ...
    jQuery(function() {
      var cHeight = document.getElementsByClassName('contents').scrollHeight;
...
function anime_true_click() {
  ...
  loadCSS('/css/anime/', document.getElementById('loadcss'));
