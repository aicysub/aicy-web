...
?>
<title>ツール - あいしぃーのさーばー</title>
<meta name="description" content="あいしぃーのサーバー" />
<meta property="og:type" content="HP" />
<meta property="og:title" content="ツール" />
<meta property="og:description" content="ツール一覧" />
...
<h2 class="h2 title">ツール</h2>
<?php require("/hdd/aic/edit.php");?>
<div class="box">
<div class="tools">
<a class="card-tools" href="/tools/convert/">
...
<hr>
<p class="center">mp3変換ツール</p>
<p class="card-word">flac・mp4・ogg・wav・webmを<br>mp3に変換するツールです。</p>
</a>
<a class="card-tools" href="/tools/ip/">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M400 0C426.5 0 448 21.49 448 48V144C448 170.5 426.5 192 400 192H352V224H608C625.7 224 640 238.3 640 256C640 273.7 625.7 288 608 288H512V320H560C586.5 320 608 341.5 608 368V464C608 490.5 586.5 512 560 512H400C373.5 512 352 490.5 352 464V368C352 341.5 373.5 320 400 320H448V288H192V320H240C266.5 320 288 341.5 288 368V464C288 490.5 266.5 512 240 512H80C53.49 512 32 490.5 32 464V368C32 341.5 53.49 320 80 320H128V288H32C14.33 288 0 273.7 0 256C0 238.3 14.33 224 32 224H288V192H240C213.5 192 192 170.5 192 144V48C192 21.49 213.5 0 240 0H400zM256 64V128H384V64H256zM224 448V384H96V448H224zM416 384V448H544V384H416z"/></svg>
<hr>
<p class="center">IPアドレスチェッカー</p>
<p class="card-word">自分のIPアドレスを確認したり<br>Whois・住所検索ができます。</p>
</a>
<a class="card-tools" href="/tools/amazon/">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M257.2 162.7c-48.7 1.8-169.5 15.5-169.5 117.5 0 109.5 138.3 114 183.5 43.2 6.5 10.2 35.4 37.5 45.3 46.8l56.8-56S341 288.9 341 261.4V114.3C341 89 316.5 32 228.7 32 140.7 32 94 87 94 136.3l73.5 6.8c16.3-49.5 54.2-49.5 54.2-49.5 40.7-.1 35.5 29.8 35.5 69.1zm0 86.8c0 80-84.2 68-84.2 17.2 0-47.2 50.5-56.7 84.2-57.8v40.6zm136 163.5c-7.7 10-70 67-174.5 67S34.2 408.5 9.7 379c-6.8-7.7 1-11.3 5.5-8.3C88.5 415.2 203 488.5 387.7 401c7.5-3.7 13.3 2 5.5 12zm39.8 2.2c-6.5 15.8-16 26.8-21.2 31-5.5 4.5-9.5 2.7-6.5-3.8s19.3-46.5 12.7-55c-6.5-8.3-37-4.3-48-3.2-10.8 1-13 2-14-.3-2.3-5.7 21.7-15.5 37.5-17.5 15.7-1.8 41-.8 46 5.7 3.7 5.1 0 27.1-6.5 43.1z"/></svg>
<hr>
<p class="center">Amazon検索ツール</p>
<p class="card-word">国内倉庫発行のみのAmazon商品を<br>検索することができます。</p>
</a>
</div>
<div class="tools">
<a class="card-tools" href="/tools/youtube/">
...
<hr>
<p class="center">動画ダウンロードツール</p>
<p class="card-word">YouTubeなどの動画を動画や音声<br>としてダウンロードできます。</p>
</a>
</div>
<hr>
<div id="ads"></div>
