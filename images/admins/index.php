...
?>
<title>/admins/ - あいしぃーのさーばー</title>
<div class="contents"><div class="main">
    <h2 class="title h2">一覧</h2>
<?php
//ディレクトリ名
$jpg = glob('/hdd/aic/images/admins/*jpg');
...
$png = glob('/hdd/aic/images/admins/*png');
foreach($png as $pngv) {
...
$svg = glob('/hdd/aic/images/admins/*svg');
foreach($svg as $svgv) {
...
$ico = glob('/hdd/aic/images/admins/*ico');
foreach($ico as $icov) {
...
$gif = glob('/hdd/aic/images/admins/*gif');
foreach($gif as $gifv) {
